...
const usefulLinks = [
  ...
  { id: 4, link: "/privacypolicy", item: "Privacy Policy" },
  { id: 5, link: "/deleteaccount", item: "Delete Account" },
            ...
            <Col lg={3} className="mb-lg-0 mb-5">
              ...
              <div className="footer-info">
                ...
                <div className="footer-info-text my-4">
                  <p>
                    Pitch Pro makes booking football pitches easy and
                    hassle-free. Find, book, and pay for your next game—all in
                    one app.
                  </p>
                </div>
              </div>
          ...
          <Row>
            <Col md={12}>
              ...
              <div className="copy-right text-center mt-5 pt-5">
                Copyright 2024 Ultron systems | Created by Ultron systems
                <br />
              </div>
              {/* - Copyright - */}
            </Col>
